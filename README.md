...
Category-First Navigation: The homepage immediately segments the experience into Petrol, Diesel, and EV hubs. Each hub has tailored filters. Petrol and Diesel filters include engine displacement, mileage, transmission, and emission norms like BS6. The EV hub replaces those with battery capacity, range, charging time, charger type, and battery warranty.

Smart Comparison Tool: Users can select up to four cars across any category to compare specs, running cost per km, estimated yearly fuel or charging cost, and emissions. For EVs, the tool shows savings versus petrol equivalents based on local fuel and electricity rates in Siliguri and across India.

Advanced Search and Filters: Beyond category, users can filter by price band, body type, brand, year, RTO location, features, and dealer ratings. A Fuel Type Advisor quiz helps undecided buyers by asking about daily commute, charging access, and budget to recommend a category.

Detailed Vehicle Pages: Every listing includes high-resolution image galleries, 360 degree views, variant-wise pricing, EMI calculator, and a TCO breakdown. Petrol and Diesel pages highlight mileage and service intervals. EV pages emphasize range, charging network map, government subsidies, and home charger installation guides.

Dealer and User Dashboards: Verified dealers get an inventory management dashboard with leads, analytics, and promotional tools. Users can save favorites, set price drop alerts, and book test drives directly through the platform.
